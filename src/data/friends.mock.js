export const mockFriends = [
    ...
    posts: [
      {
        id: "p1",
        type: "image",
        description: "new growth 🌿 can’t believe this little one survived!",
      ...
      },
      {
        id: "p2",
        type: "text",
        text: "nothing beats slow mornings 🌞",
    ...
    posts: [
      {
        id: "p1",
        type: "text",
        text: "felt like fighting a dragon with a spoon lol",
        description: "finally fixed that nasty bug 👾",
        date: "2025-09-30",
        likes: 210,
      },
      {
  ...
  },
  {
    ...
    stories: [
      "/assets/images/stories/kaia-1.png",
    ],
    posts: [
      {
        id: "p1",
